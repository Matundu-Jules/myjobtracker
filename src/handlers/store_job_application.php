...
require_once __DIR__ . '/../core/database.php'; // Load the database connection
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        // Log to local PHP console (e.g. terminal) — safe for dev use
        error_log("✅ New job application added: " . json_encode($data));

        // Display a clean confirmation (optional to keep in production)
